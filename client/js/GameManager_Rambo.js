...
var GameManager = function()
{
    ...
    var objs = [
        ...
        new paddle('black', 40, 500, 15, 200),
        new paddle('black', 1000 - 50, 500, 15, 200)
    ];
    ...
    window.setInterval(function() {
        if (objs.length < 25) {
            objs.push(new ball('red', objs[4].x+30, objs[4].y + 100, 10, 8, objs[4].vy, 0, 0, 0.01));
            objs.push(new ball('green', objs[5].x-30, objs[5].y + 100, 10, -8, objs[5].vy, 0, 0, 0.01));
        }
    }, 2000);
};
