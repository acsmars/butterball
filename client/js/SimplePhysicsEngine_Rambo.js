        ...
        for (index = 0, len = objects.length; index < len; ++index) {
			...
			if (value) {
				...
				newObjects[index].owner = UUID;
                    ...
                    if(isBallReset) {
                        //Reset Ball
                        if (newObjects[index].x < 500) {
                            newObjects[index].x = newObjects[4].x + 20;
                            newObjects[index].y = newObjects[4].y + 100;
                            newObjects[index].vy = newObjects[4].vy;
                            newObjects[index].vx = 4;
                            newObjects[index].color = 'red';
                        } else {
                            newObjects[index].x = newObjects[5].x - 20;
                            newObjects[index].y = newObjects[5].y + 100;
                            newObjects[index].vy = newObjects[5].vy;
                            newObjects[index].vx = -4;
                            newObjects[index].color = 'green';
                        } 
